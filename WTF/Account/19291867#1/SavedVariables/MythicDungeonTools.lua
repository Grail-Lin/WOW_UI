					...
					["objects"] = {
						...
						}, -- [2]
						{
							["d"] = {
								...
								2, -- [3]
								true, -- [4]
								"软泥怪吃控，车队的话可以考虑打掉2只之后控一只带到2号平台哪里出傲慢。\n（未验证可以带过去不，应该可以的）", -- [5]
							},
							["n"] = true,
						}, -- [3]
						{
